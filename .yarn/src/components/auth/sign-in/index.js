            ...
            <RTL direction={languageDirection}>
                ...
                >
                    ...
                    <CustomStackFullWidth
                        ...
                        spacing={{ xs: 1, md: 2 }}
                    >
                        <form onSubmit={loginFormik.handleSubmit} className='w-100 mt-2' noValidate>
                            <CustomStackFullWidth
                                alignItems="center"
                                spacing={{ xs: 2, md: 2 }}
                            >
                            ...
                            <div className='d-md-flex justify-content-between align-items-center mt-3 mb-3'>
                               <div className=''>
                                <h6 className='mb-0'>{t('Create An Account?')} <span onClick={() => {
                                    setModalFor('sign-up')
                                }} className='text_color cursor-pointer' >{t('Register')}</span ></h6>
                               </div>
                            <Typography
                            variant="body2"
                            onClick={gotoForgotPassword}
