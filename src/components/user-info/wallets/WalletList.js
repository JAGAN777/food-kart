...
import emptyData  from '../../../../public/static/images/emp_sub.png'
    ...
    return (
        <>
            <Meta
                ...
                keywords=""
            />
            <CustomPaperBigCard padding="1.9rem" sx={{backgroundColor:'#F6F6F6'}}>

                {
                    profileData?.data?.wallet_balance != 0 ?  
                <Grid container spacing={3.5}>
                 ...
                 <Grid  >
                    ...
                    <div className='net_banking'>
                        <div className='border-bottom d-sm-flex justify-content-between align-items-center p-2'>
                            <div className='d-flex  align-items-center mb-3'>
                                <div className=''>
                                    <img src='/static/images/card.png' className='' />
                                </div> 
                                <div className='ms-3'>
                                    <h6 className='mb-2'>Card</h6>
                                    <p className='mb-0 comlplete_1'>Visa, Master Card, Rupay & More</p>
                                </div>
                            </div>

                            <div  className='d-flex justify-content-center'>
                                <h6 className='text_color cursor-pointer'>Link</h6>
                            </div>

                        </div>
                        <div className='border_bottom-1 d-sm-flex justify-content-between align-items-center p-2'>
                            <div className='d-flex  align-items-center mb-3'>
                                <div className=''>
                                    <img src='/static/images/bank.png' className='' />
                                </div> 
                                <div className='ms-3'>
                                    <h6 className='mb-2'>Netbanking</h6>
                                    <p className='mb-0 comlplete_1'>Pay With installed app, or use others.</p>
                                </div>
                            </div>
