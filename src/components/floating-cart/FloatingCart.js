...
import emptycart from '../../../public/static/images/Cart.png'
...
const FloatingCart = (props) => {
    ...
    const {
        ...
        RestaurantsApi.restaurantDetails(1)
    )
        ...
        <>
            ...
            <RTL direction={languageDirection}>
                <Drawer
                    ...
                    variant="temporary"
                >
                    <DrawerHeader>FOOD KART</DrawerHeader>
                    {cartList?.length === 0 ? (
                        <Stack
                            sx={{
                                width: '330px',
                                                ...
                                                <Grid item md={8} xs={8}>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                {item?.plans?.category_name}({item?.name})
                                                            </OrderFoodName>
                                                            {item?.variations
                                                                ?.length >
                                                                0 && (
                                                        ...
                                                        >
                                                            {/* <Stack
                                                                ...
                                                                spacing={1}
                                                            >
                                                            <OrderFoodAmount>Price:</OrderFoodAmount>
                                                            <OrderFoodAmount>
                                                                {getAmount(
                                                            ...
                                                            {/* <Stack
                                                                ...
                                                                spacing={1}
                                                            > */}
                                                            {/* <OrderFoodAmount>Plan:</OrderFoodAmount> */}
                                                            <OrderFoodAmount>
                                                            {getAmount(
                                                                    handleTotalAmountWithAddonsFF(
                                                                        item?.totalPrice,
