...
const MapModal = ({ open, handleClose }) => {
    ...
    const [location, setLocation] = useState({
        lat:'13.037322264989617',lng:'80.21231152117252'
    })
    ...
    // const handleAgreeLocation = async () => {
    //         setLocation({ lat: '13.037322264989617', lng: '80.21231152117252' })
    //         setLoadingCurrentLocation(true)
    //         // setLocationEnabled(true)
    //         setLoadingCurrentLocation(false)
    ...
    return (<>
    <button className='d-none' id='getCurrentLoactionWithid' onClick={()=>handleAgreeLocation()}></button>
        <Modal
            open={open}
            onClose={handleClose}
