...
const SubscriptionDetails = props => {
    ...
    return (<CustomStackFullWidth sx={{
        ...
        <CustomModal openModal={openDeliveryLog}
            ...
            <Logs title='Delivery Log' t={t} logs={data} Sub={subscriptionData} offset={deliveryOffset} setOffset={setDeliveryOffset}
                  isRefetching={isRefetching}/>

        </CustomModal>
        <CustomModal openModal={openPauseLog}
                     setModalOpen={setOpenPauseLog}>
            <Logs title='Skip Log' t={t} logs={pauseLogData} offset={pauseOffset} setOffset={setPauseOffset}
