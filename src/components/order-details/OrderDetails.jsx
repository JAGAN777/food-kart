                                ...
                                data?.data?.details?.map((product) => (
                                    ...
                                    >
                                        ...
                                        <Grid item md={9} xs={8} sm={8}>
                                            <OrderFoodName>
                                                {/* {product?.food_details?.category_id == 1?'South Indian':product?.food_details?.category_id == 2 ? 'North Indian' :product?.food_details?.category_id == 3 ? 'Jain Food':product?.food_details?.category_id == 4 ? 'Special Meals':''}{`(${product?.food_details?.name})`} */}
                                                {product?.category_name}{`(${product?.food_details?.name})`}
                                            </OrderFoodName>
                                            <OrderFoodName>
                                            ...
                                            {
                                             trackData?.data?.otp && 
                                            <OrderFoodName>{t('OTP')}:{trackData?.data?.otp}</OrderFoodName> 
                                            }
                                        </Grid>
                        ...
                        >
                            ...
                            <Grid item md={4} xs={4}>
                                <Typography variant="h5" align="right">
                                    {trackData &&
                                        getAmount(
                                            trackData?.data?.original_delivery_charge ?? 0,
                                            currencySymbolDirection,
                                            currencySymbol,
                                            digitAfterDecimalPoint
                                        )}
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} container>
                                    <Reorder
                                        ...
                                        orderZoneId={
                                            trackData?.data?.restaurant?.zone_id
                                        }
                                    />
                                </Grid>
                            </Grid>
