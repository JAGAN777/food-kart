            ...
            <RTL direction={languageDirection}>
                ...
                >
                    ...
                    <CustomStackFullWidth
                        ...
                        spacing={{ xs: 1, md: 2 }}
                    >
                                            <form onSubmit={signUpFormik.handleSubmit} className='w-100 mt-2' noValidate>
                        <CustomStackFullWidth
                            alignItems="center"
                            spacing={{ xs: 2, md: 3 }}
                        >
                            ...
                            <FormControl variant="outlined" fullWidth className='me-1'>
                                <InputLabel
                                    required
                                    sx={{
                                        color: (theme) =>
                ...
                <div className='d-flex justify-content-center align-items-center mt-3'>
                                <h6 className='mb-0'>{t('Already have an account?')} <span onClick={()=> setModalFor('sign-in')} className='text_color cursor-pointer' >{t('Login')}</span ></h6>
                               </div>
                </CustomStackFullWidth>
                <CustomModal
