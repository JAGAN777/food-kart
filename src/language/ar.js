export const arabic = {
    ...
    'Current orders can not be reordered as some changes occurred to the items.':
        '.لا يمكن إعادة ترتيب الطلبات الحالية حيث حدثت بعض التغييرات على العناصر',
    'No logs found': 'لم يتم العثور على سجلات',
    'Reorder-able items added to the cart successfully.':
        'تمت إضافة العناصر التي يمكن إعادة ترتيبها إلى عربة التسوق بنجاح.',
